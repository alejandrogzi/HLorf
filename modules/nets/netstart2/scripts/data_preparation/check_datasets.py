...
for filename in filenames:
    with gzip.open(
        f"../../data/data_model_preparation/datasets/non_TIS/mRNA/" + filename, "rt"
    ) as file:
        file.readline()
...
for filename in filenames:
    print(filename)
    with gzip.open(
        f"../../data/data_model_preparation/datasets/TIS/" + filename, "rt"
    ) as file:
        file.readline()
        # Iterate line by line
        for line in file:
...
for filename in filenames:
    with gzip.open(
        f"../../data/data_model_preparation/datasets/non_TIS/introns/" + filename, "rt"
    ) as file:
        file.readline()
        # Iterate line by line
        for line in file:
...
for filename in filenames:
    with gzip.open(
        f"../../data/data_model_preparation/datasets/non_TIS/intergenic/" + filename,
        "rt",
    ) as file:
        file.readline()
        # Iterate line by line
